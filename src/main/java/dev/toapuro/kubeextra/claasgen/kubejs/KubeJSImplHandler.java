...
public class KubeJSImplHandler {
    ...
    private static final Map<String, CallbackClass> classCallbackMap = new HashMap<>();
    ...
    public static void clearImplMap() {
        classCallbackMap.clear();
    }

    public static void putClassCallback(String className, CallbackClass callback) {
        classCallbackMap.put(className, callback);
    }
}
