package dev.toapuro.advancedkjs.bytes.claasgen.generator;

import dev.toapuro.advancedkjs.bytes.common.BytecodeLocalStack;
...
import dev.toapuro.advancedkjs.bytes.claasgen.arguments.SuperParamArgument;
import dev.toapuro.advancedkjs.bytes.claasgen.arguments.SuperParamConstArgument;
import dev.toapuro.advancedkjs.bytes.claasgen.arguments.SuperParamFunctionArgument;
import dev.toapuro.advancedkjs.bytes.claasgen.construction.GenClass;
import dev.toapuro.advancedkjs.bytes.claasgen.construction.GenConstructor;
import dev.toapuro.advancedkjs.bytes.claasgen.construction.GenMethod;
import dev.toapuro.advancedkjs.bytes.claasgen.generated.GeneratedConstructor;
import dev.toapuro.advancedkjs.bytes.claasgen.kubejs.JavaMethodContext;
