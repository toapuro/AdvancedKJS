...
import dev.toapuro.advancedkjs.bytes.claasgen.kubejs.callback.ConstantFunction;
...
public class KubeConstructorBuilderJS extends KubeMethodBuilderJS {
    ...
    public static class Result extends KubeMethodBuilderJS.Result {
        ...
        public Result(String methodName, String descriptor, MethodParameterTypes parameters, List<GenAnnotation> annotations, CtClass returnValue, int modifiers, BaseFunction function, List<SuperParamArgument> superArguments) {
